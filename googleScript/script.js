var SS = SpreadsheetApp.openById('myIdSpreadSheet');
var str = "";
  ...
  if (parsedData !== undefined){
    ...
    switch (parsedData.command) {
      ...
      case "insert_row":
         ...
         // use this to insert cells just above the existing data instead of inserting an entire row
         //range.insertCells(SpreadsheetApp.Dimension.ROWS); 
         // use this to insert cells just above the existing data instead of inserting an entire row
         
         sheet.getRange('A2').setValue(date_now); // publish current date to cell A2
         sheet.getRange('B2').setValue(value0);   // publish value0 from Arduino code to cell C2
         sheet.getRange('C2').setValue(value1);   // publish value1 from Arduino code to cell D2
         sheet.getRange('D2').setValue(value2);   // publish value2 from Arduino code to cell E2
      ...
      case "append_row":
         ...
         publish_array [1] = value0;   // add value0 from Arduino code to position 2 in publish_array
         publish_array [2] = value1;   // add value1 from Arduino code to position 3 in publish_array
         publish_array [3] = value2;   // add value2 from Arduino code to position 4 in publish_array
